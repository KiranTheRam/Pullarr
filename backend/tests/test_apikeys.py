...
from pullarr.api import apikeys
from pullarr.api.deps import require_api_key
from pullarr.models import ApiKey, Base
from pullarr.schemas import ApiKeyCreateIn
...
async def test_require_api_key_accepts_managed_key(session, monkeypatch):
    monkeypatch.setattr("pullarr.api.deps.get_api_key", lambda: "bootstrap-key")
